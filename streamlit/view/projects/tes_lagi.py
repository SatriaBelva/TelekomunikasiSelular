...
gdf = gpd.read_file(shapefile_path) # Sudah Di Model

# Sidebar untuk filter wilayah
kecamatan_list = sorted(gdf['WADMKC'].unique()) # Sudah Di Model
selected_kecamatan = st.sidebar.selectbox("Pilih Kecamatan", ["Semua"] + kecamatan_list)
# Filter desa tergantung kecamatan yang dipilih
